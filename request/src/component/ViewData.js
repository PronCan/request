        ...
        <div>
            ...
            <div className='info_warp'>
                ...
                <ul>
                    ...
                    <div className='input-radio input-radio-list'>
                            <label>
                                <input type='checkbox' name='info6' value={'선택1'} checked={radioState === '선택1'} onChange={(handleRadioBtn)}/>
                                선택1
                            </label>
                            <label>
                                <input type='checkbox' name='info6' value={'선택2'} checked={radioState === '선택2'} onChange={handleRadioBtn}/>
                                선택2
                            </label>
                            <label>
                                <input type='checkbox' name='info6' value={'선택3'} checked={radioState === '선택3'} onChange={handleRadioBtn}/>
                                선택3
                            </label>
                        </div>
                    </li>
